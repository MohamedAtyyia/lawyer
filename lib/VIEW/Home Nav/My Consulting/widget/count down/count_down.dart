// import 'package:al_mostashar_lawyer/VIEW/Home%20Nav/My%20Consulting/widget/count%20down/to_arabic_convert.dart';
// import 'package:flutter/material.dart';
// import 'package:flutter/widgets.dart';
// import 'package:flutter_screenutil/flutter_screenutil.dart';
// import 'controller.dart';
// import 'current_remaining.dart';
...
//         style: TextStyle(fontFamily: 'tajwal', fontSize: 15),
//       ),
//     ),
//     this.widgetBuilder,
//     this.controller,
...
//     value = '$value${sec.toArabicNumbers} : ';
//     var min = _getNumberAddZero(time.min ?? 0);
//     value = '$value${min.toArabicNumbers} : ';
//     var hours = _getNumberAddZero(time.hours ?? 0);
//     value = '$value${hours.toArabicNumbers}  ';
//     return Text(
//       value,
//       style: textStyle,
//     );
...
//     if (number < 10) {
//       return "0" + number.toString().toArabicNumbers;
//     }
